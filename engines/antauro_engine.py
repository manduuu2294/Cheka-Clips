...
def generate_clips_from_chunk(transcripcion: str, api_key: str, max_clips: int = 15,
    ...
    Eres un analista político experto en el movimiento etnocacerista peruano. Tu misión es extraer clips de alto valor donde **Antauro Humala** expone su visión de país, propuestas de gobierno, denuncias contra el sistema y mensajes de cambio para el Perú.

    CONTEXTO SOBRE ANTAURO HUMALA:
    - Líder del movimiento etnocacerista (nacionalismo andino, reivindicación de la identidad cobriza/indígena)
    - Exmayor del Ejército Peruano, lideró el Locumbazo (2000) y el Andahuaylazo (2005)
    - Propone: nueva Constitución, nacionalismo económico, soberanía territorial
    - Reivindica la cultura andina y el Tahuantinsuyo
    - Antiimperialista, antiglobalismo, rechazo al neoliberalismo
    - Propone pena capital para delitos graves
    - Defensor de los reservistas y veteranos del Ejército

    CRITERIOS PARA SELECCIONAR CLIPS:
    1. PROPUESTAS DE GOBIERNO Y VISIÓN DE PAÍS
    2. RECUPERACIÓN DE LA IDENTIDAD NACIONAL
    3. SOBERANÍA Y DEFENSA NACIONAL
    4. DENUNCIAS CONTRA EL SISTEMA
    5. MENSAJE DE ESPERANZA Y CAMBIO
    6. ECONOMÍA NACIONALISTA
    7. JUSTICIA SOCIAL

    REGLAS:
    - DURACIÓN MÍNIMA: 40 segundos. Duración ideal: 50 a 120 segundos.
    - El clip debe tener INICIO y CIERRE con sentido completo.
    - Cada clip debe ser AUTOCONTENIDO.
    - Prioriza clips donde Antauro Humala es QUIEN HABLA.
...
{viral_section}
    ...
    [
      {{
        "start": "HH:MM:SS",
        "end": "HH:MM:SS",
        "title": "Título claro del clip",
        "hook": "Frase textual inicial del clip",
        "descripcion": "Explicación del contenido",
        "why": "Por qué este clip es importante",
        "confidence": 0.95,
        "tiktok_copy": "Texto viral listo para TikTok. Debe sonar natural. Incluir 3-5 hashtags relevantes."
      }}
    ]
...
def generar_clips(youtube_url: str, api_key: str, lang: str = "es",
